...
<head>
    ...
    <title>Wajarri Online Dictionary</title>
...
<body>
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <h4 class="title"><a class="home" href="../dictionary/">Online Wajarri Talking Dictionary</a></h4>

            <hr>

            <!-- Search by letter (title).  -->

            <h4 class="subsubheader">English to Wajarri</h4>
